...
new const vModel[]	=	"models/minecraft/wood/model_rece_wood.mdl";
new const pModel[]	=	"models/p_knife.mdl";

new const normalModel[]	=	"models/minecraft/wood/model_wood.mdl";
new const littleModel[]	=	"models/minecraft/wood/model_wood_little.mdl";
...
public plugin_init(){
	...
	registerNewObject( "Wood" , 64 , CAN_DROP , 50 );
}
